...
def main():
    ...
    if not creds_path:
        print("❌ Missing credentials file. Please ensure you have set up the Google Play credentials correctly.")
    ...
    if version_code is not None:
        print(f"__version_code__={version_code}")
    else:
        print("__version_code__=0")  # Assume 0 if none found
